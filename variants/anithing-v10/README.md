# Instructions on how to install AniThing v1.0
...
10. Open the `config.json` file and replace the "...AniThing v1.0..." with the transaction ID of the Model Script, inside the comas. You can find it on the Studio application, on the Operators flow, where you downloaded the needed files for this installation, with the button "copy to clipboard"
