# Instructions on how to install AniMesh V2.2
...
10. Open the `config.json` file and replace the "...AniMesh V2.2..." with the transaction ID of the Model Script, inside the comas. You can find it on the Studio application, on the Operators flow, where you downloaded the needed files for this installation, with the button "copy to clipboard"
